...
public class generarPDF {
    ...
    public static void generatePDF() throws BadElementException, MalformedURLException, IOException, NoDriverFoundException, SQLException, SQLSintaxError{
    	datosNom.clear();
    	datos.clear();
    ...
    private static void getCabeceras() throws NoDriverFoundException, SQLException, SQLSintaxError{
    ...
    private static void getDatos() throws NoDriverFoundException, SQLException, SQLSintaxError{
